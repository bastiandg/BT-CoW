...
Die Methode für die Auswahl lässt den Benutzer zwischen allen ausgeschalteten virtuellen Maschinen auswählen. Diese werden wie im folgenden Listing \ref{vmlist} über die Virtualisierungs-API abgerufen.
\\
