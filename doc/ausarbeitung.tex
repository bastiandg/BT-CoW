...
\begin{figure}[htbp]
      \begin{center}
        \includegraphics[width=80px]{inc/ccby} \hskip0.5cm
	\includegraphics[width=80px]{inc/cc-nc-eu} \hskip0.5cm
	\includegraphics[width=80px]{inc/ccsa}
      \end{center}
     \end{figure}

Diese Arbeit ist unter einem Creative Commons Attribution-NonCommer-cial-ShareAlike 3.0 Germany Lizenzvertrag lizenziert. Die vollständige Lizenz ist auf der beigefügten CD oder im Internet unter der Adresse 
\hyperlink{http://creativecommons.org/licenses/by-nc-sa/3.0/de/}{http://creativecommons.org/licenses/by-nc-sa/3.0/de/}
zu finden.
